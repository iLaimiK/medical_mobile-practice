...
import { ref } from "vue";
import FolloDoctor from "./components/FolloDoctor.vue";
import KnowlefgeList from "./components/KnowlefgeList.vue";
  ...
  <div class="home-page">
      ...
      <van-row>
        <van-col span="8">
          <router-link to="/" class="nav">
            <SvgIcon name="home-doctor"></SvgIcon>
            <p class="title">问医生</p>
        ...
        <van-col span="8">
          <router-link to="/consult/fast" class="nav">
            <SvgIcon name="home-graphic"></SvgIcon>
        ...
        <van-col span="8">
          <router-link to="/" class="nav">
            <SvgIcon name="home-prescribe"></SvgIcon>
      ...
      <van-row>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgIcon name="home-order"></SvgIcon>
            <p class="title">药品订单</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgIcon name="home-docs"></SvgIcon>
            <p class="title">健康档案</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgIcon name="home-rp"></SvgIcon>
            <p class="title">我的处方</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <SvgIcon name="home-find"></SvgIcon>
    ...
    <van-tabs shrink sticky v-model:active="active">
      <van-tab title="关注" name="like">
        <follo-doctor />
        <knowlefge-list type="like" />
      </van-tab>
      <van-tab title="推荐">
        <knowlefge-list type="recommend" />
      </van-tab>
      <van-tab title="减脂">
        <knowlefge-list type="fatReduction" />
      </van-tab>
      <van-tab title="饮食">
        <knowlefge-list type="food" />
      </van-tab>
    </van-tabs>
  </div>
</template>
